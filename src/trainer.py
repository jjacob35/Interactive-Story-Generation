...
def train_and_fit(args):
    ...
    plt.savefig(os.path.join(os.getcwd() + "/src/data/" ,"loss_vs_epoch_%d.png" % args.model_no))
    ...
    plt.savefig(os.path.join(os.getcwd() + "/src/data/" ,"accuracy_vs_epoch_%d.png" % args.model_no))
