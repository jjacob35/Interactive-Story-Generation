...
def load_results(model_no=0):
    ...
    losses_path = os.getcwd() + "/src/data/task_test_losses_per_epoch_%d.pkl" % model_no
    accuracy_path = os.getcwd() + "/src/data/task_train_accuracy_per_epoch_%d.pkl" % model_no
    f1_path = os.getcwd() + "/src/data/task_test_f1_per_epoch_%d.pkl" % model_no
