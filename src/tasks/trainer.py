...
def train_and_fit(args):
    ...
    if args.use_pretrained_blanks == 1:
        ...
        checkpoint_path = os.getcwd() + "/src/data/test_checkpoint_%d.pth.tar" % args.model_no
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        if accuracy_per_epoch[-1] > best_pred:
            ...
            torch.save({
                ...
                }, os.path.join(os.getcwd() + "/src/data/" , "task_test_model_best_%d.pth.tar" % args.model_no))
        ...
        if (epoch % 1) == 0:
            ...
            torch.save({
                    ...
                    'scheduler' : scheduler.state_dict(),\
                    'amp': amp.state_dict() if amp is not None else amp
                }, os.path.join(os.getcwd() + "/src/data/" , "task_test_checkpoint_%d.pth.tar" % args.model_no))
    ...
    plt.savefig(os.path.join(os.getcwd() + "/src/data/" ,"task_loss_vs_epoch_%d.png" % args.model_no))
    ...
    plt.savefig(os.path.join(os.getcwd() + "/src/data/" ,"task_train_accuracy_vs_epoch_%d.png" % args.model_no))
    ...
    plt.savefig(os.path.join(os.getcwd() + "/src/data/" ,"task_test_f1_vs_epoch_%d.png" % args.model_no))
