...
def preprocess_fewrel(args, do_lower_case=True):
    ...
    with open(os.getcwd() + '/src/data/fewrel/train_wiki.json') as f:
        train_data = json.load(f)
        
    with  open(os.getcwd() + '/src/data/fewrel/val_wiki.json') as f:
...
def load_dataloaders(args):
    ...
    if os.path.isfile(os.getcwd() + "/src/data/%s_tokenizer.pkl" % model_name):
        ...
        if args.model_no == 2:
            tokenizer = Tokenizer(vocab_file=os.getcwd() + '/additional_models/biobert_v1.1_pubmed/vocab.txt',
                                  do_lower_case=False)
        else:
    ...
    if args.task == 'semeval':
        relations_path = os.getcwd() + '/src/data/relations.pkl'
        train_path = os.getcwd() + '/src/data/df_train.pkl'
        test_path = os.getcwd() + '/src/data/df_test.pkl'
